  ...
  return (
    <Fade>
      <section className="home">
        ...
        <button className="btn-flotante" onClick={handleClick}>
          <img src={Boton} target="_self" alt="" />
        </button>
        ...
        <div className="contenedor-legales">
          <small>
            MATERIAL DE ENTRENAMIENTO PARA EXCLUSIVO USO INTERNO DE ALLERGAN
            AESTHETICS – PROHIBIDA SU REPRODUCCIÓN
          </small>
          <br />
          <small>
            ©2021 Allergan. Todos los derechos reservados. Todas las marcas son
